...
<div class="single_center">
    ...
    <div id="create-container" class="container">
        ...
        {{ Form::open(array('url' => 'admin/product/'.$product->code, 'method'=>'post', 'files' => true)) }}
        {{ Form::token() }}
        ...
        <div class="form-group">
            ...
            {{ Form::text('image_before',str_replace(ProductController::imagePath(), "" ,$product->image),array('disabled', 'class' => 'form-control','disabled', 'style'=>'width: 50%;')) }}
        </div>
        ...
        <a href="{{ URL::to('admin/product') }}" class="btn btn-success">Return</a>
    </div>
</div>
@stop