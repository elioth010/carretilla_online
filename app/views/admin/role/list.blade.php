...
<section>
    <div id=principal class="container" >
        ...
        <a href="{{action("RoleController@create")}}" class="btn btn-success">Add</a>
        <br/>
        <br/>
            ...
            <table id="datatable-role" class="table table-striped table-bordered">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td> 
                            <a href="{{URL::to('admin/role/'.$role->id)}}" class="btn btn-info">View</a>
                            <a href="{{URL::to('admin/role/'.$role->id.'/edit')}}" class="btn btn-default">Edit</a>
                            <a href="{{URL::to('admin/role/'.$role->id.'/delete')}}" class="btn btn-danger">Delete</a>
                        </td>
                    </tr>
                    @endforeach
                </tbody>
